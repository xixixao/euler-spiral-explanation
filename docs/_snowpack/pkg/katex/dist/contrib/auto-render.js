...
defineSymbol(text$1, main, textord, "¶", "\\P");
...
defineSymbol(text$1, main, textord, "‡", "\\textdaggerdbl");
...
defineSymbol(text$1, ams, textord, "✓", "\\checkmark");
...
defineSymbol(text$1, main, textord, "<", "\\textless", true);
defineSymbol(text$1, main, textord, ">", "\\textgreater", true);
...
defineSymbol(text$1, main, textord, "|", "\\textbar", true);
defineSymbol(math, main, textord, "∥", "\\|");
defineSymbol(math, main, textord, "∥", "\\Vert");
...
defineSymbol(text$1, main, textord, "Œ", "\\OE", true);
defineSymbol(text$1, main, textord, "Ø", "\\O", true);
defineSymbol(text$1, main, accent, "ˊ", "\\'");
defineSymbol(text$1, main, accent, "ˋ", "\\`");
defineSymbol(text$1, main, accent, "ˆ", "\\^");
defineSymbol(text$1, main, accent, "˜", "\\~");
defineSymbol(text$1, main, accent, "ˉ", "\\=");
defineSymbol(text$1, main, accent, "˘", "\\u");
defineSymbol(text$1, main, accent, "˙", "\\.");
defineSymbol(text$1, main, accent, "˚", "\\r");
defineSymbol(text$1, main, accent, "ˇ", "\\v");
defineSymbol(text$1, main, accent, "¨", '\\"');
defineSymbol(text$1, main, accent, "˝", "\\H");
defineSymbol(text$1, main, accent, "◯", "\\textcircled");
var ligatures = {
  "--": true,
  "---": true,
  "``": true,
...
defineSymbol(text$1, main, textord, "”", "''", true);
defineSymbol(text$1, main, textord, "”", "\\textquotedblright");
defineSymbol(math, main, textord, "°", "\\degree", true);
defineSymbol(text$1, main, textord, "°", "\\degree");
defineSymbol(text$1, main, textord, "°", "\\textdegree", true);
...
defineSymbol(text$1, main, mathord, "h", "ℎ");
var wideChar = "";
...
defineSymbol(text$1, main, textord, "k", wideChar);
...
var buildExpression$1 = function buildExpression3(expression, options, isOrdgroup) {
  if (expression.length === 1) {
...
var buildGroup$1 = function buildGroup3(group, options) {
  if (!group) {
...
var mathmlBuilder$1 = (group, options) => {
  var inner2 = buildExpression$1(group.body, options.withColor(group.color));
...
defineFunction({
  ...
  mathmlBuilder: (group, options) => {
    assertParsed(group);
    var inner2 = buildExpression$1(group.body, options);
    if (group.left !== ".") {
...
var htmlBuilder$3 = function htmlBuilder2(group, options) {
  var r;
  var c;
...
var mathmlBuilder$3 = function mathmlBuilder2(group, options) {
  var tbl = [];
...
var htmlBuilder$7 = (grp, options) => {
  ...
  var body = buildGroup(group.base, options.havingBaseStyle(Style$1.DISPLAY));
...
var mathmlBuilder$9 = (group, options) => {
  var expression = buildExpression$1(group.body, options.withFont("mathrm"));
...
defineFunction({
  ...
  mathmlBuilder: (group, options) => {
    var inner2 = buildExpression$1(ordargument(group.body), options);
...
defineFunction({
  ...
  mathmlBuilder: (group, options) => {
    var newOptions = options.havingSize(group.size);
    var inner2 = buildExpression$1(group.body, newOptions);
    var node = new mathMLTree.MathNode("mstyle", inner2);
